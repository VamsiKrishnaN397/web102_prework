...
const unfundedGamesString = unfundedGamesCount === 1
  ? `A total of $800,268 has been raised for 11 games. Currently, ${unfundedGamesCount} games remain unfunded. We need your help to fund these amazing games!`
  : `A total of $800,268 has been raised for 11 games. Currently, ${unfundedGamesCount} games remain unfunded. We need your help to fund these amazing games!`;
...
topGameName.textContent = firstGame.name;  // `firstGame` is already destructured and assigned
firstGameContainer.appendChild(topGameName);

runnerUpGameName.textContent = secondGame.name;  // `secondGame` is already destructured and assigned
secondGameContainer.appendChild(runnerUpGameName);
